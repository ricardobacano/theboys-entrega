...
# arquivos-objeto
	objects = theboys.o lef.o fila.o EventosMundo.o 
     
all: theboys

theboys: theboys.o conjuntonovo.o lef.o fila.o EventosMundo.o 
	$(CC) -o theboys theboys.o conjuntonovo.o lef.o fila.o EventosMundo.o $(LDFLAGS)
